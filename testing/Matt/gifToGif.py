#started as a copy from initialTest.py
...
import sys
import os
sys.path.append("/home/ahranov/REMember/dep/caffe/python")
os.system("export LD_LIBRARY_PATH=/deepdream/caffe/distribute/lib")
...
img = np.float32(PIL.Image.open('Mockus.jpg'))
showarray(img)
...
guide = np.float32(PIL.Image.open('sourceImages/flowers.jpg'))
showarray(guide)
